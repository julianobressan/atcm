...
In the API, all endpoints, except create session, are protected by JWT authentication. So, for use them, you should authenticate first and put the token in the header of request. See more details bellow.
