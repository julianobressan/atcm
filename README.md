...
In the API, all endpoints, except create session, are protected by JWT authentication. So, for use them, you should authenticate first and put the token in the header of request. See more details bellow. Tokens are programmed to expire in 130 minutes, bearing in mind that air traffic controllers can work a maximum of two hours uninterrupted. This way, they have time to log-in untill 10 minutes before the beggining of your operation and work for two hours long. If you want to change the expiration time, change the .env file.
